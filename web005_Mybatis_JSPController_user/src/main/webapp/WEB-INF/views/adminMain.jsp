...
<body>
	...
	<div style="font-size: :small">
		<div>
			<a href="./userServelet.do?command=logout">로그아웃</a>
		</div>
		<div>
			<a href="./userServelet.do?command=getAlluserStatus">회원상태 정보 조회</a>
		</div>
		<div>
			<a href="./userServelet.do?command=getAlluser">회원 정보 조회</a>
		</div>
	</div>
</body>
</html>